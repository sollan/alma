...
class RandomForestPanel(wx.Panel):
    ...
    def SelectOutputFolder(self, e):
        ...
        if export_dialog.ShowModal() == wx.ID_OK:
            ...
            self.random_forest_button = wx.Button(self, id=wx.ID_ANY, label='Run random forest classification')
            self.sizer.Add(self.random_forest_button, pos=(8, 1), flag = wx.LEFT | wx.TOP, border = 25)
    ...
    def RandomForest(self, e):
        ...
        self.random_forest_result_text = wx.StaticText(self, label=f"\nAnalysis completed!")
        self.sizer.Add(self.random_forest_result_text, pos=(8, 2), flag=wx.LEFT | wx.TOP, border=25)
